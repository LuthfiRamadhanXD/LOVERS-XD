...
$$ |     $$ |  $$ |   $$ |   $$ |  $$ |$$ |        $$ |        $$  /\$$\ $$ |  $$ |
$$$$$$$$\\$$$$$$  |   $$ |   $$ |  $$ |$$ |      $$$$$$\       $$ /  $$ |$$$$$$$  |
\________|\______/    \__|   \__|  \__|\__|      \______|      \__|  \__|\_______/ 
...
luciverganteng_banget = input(f'\n\x1b[1;92m➢ • \x1b[1;97mSilahkan Pilih Guys : ')
loading()
os.system('clear')
if luciverganteng_banget in ['1']:
	os.system("xdg-open https://wa.me/+6282246741590?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Day+5K")
elif luciverganteng_banget in ['2']:
	os.system("xdg-open https://wa.me/+6282246741590?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+2+Day+10K")
elif luciverganteng_banget in ['3']:
	os.system("xdg-open https://wa.me/+6282246741590?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+7+Day+15K+yang+diskon")
elif luciverganteng_banget in ['4']:
	os.system("xdg-open https://wa.me/+6282246741590?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Bulan+50K")
elif luciverganteng_banget in ['5']:
	os.system("xdg-open https://wa.me/+6282246741590?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+open+source+100K")
elif luciverganteng_banget in ['0']:
	exit()
loading()
os.system('clear')
banner()	
Password = "bangluci"  #--> Data Req Api key --> open_kt(life)("https://github.com/loser-401/loser/blob/main/paid.txt")


loop = 'true'
while (loop == 'true'):
    passcode = input(f"\x1b[1;97m ➢ Masukan Key : \x1b[1;92m")
    loading()
    os.system('clear')
    if (passcode == Password):
            loop = 'false'
            time.sleep(5.0)
            print(f"\n \x1b[1;97m ➢ \x1b[1;94mSedang Di Proses... ")
            time.sleep(6.0)
            print(f"\n \x1b[1;92m ➢ \x1b[1;92mBerhasil ")          
    else:
            exit(f"\x1b[1;91m ➢ \x1b[1;91mKey Salah Goblok Silahkan Hubungi Admin")
try:
	import json
	import uuid
	import hmac
